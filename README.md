...
- **右下のすきまボタン(👁)**を押すと、置いたブロックが半透明になり、
  ブロックに囲まれて見えにくい空きマスが金色に光って分かりやすくなる
...
- **詰みの救済**: ゲームオーバーで「**LINEで送って続ける**」を押すと、
  「これおもろい」+URL が入った状態で LINE 共有が開き、上のブロックが消えて続きから遊べる
...
- 出題ピースの平均体積は少し大きめに寄せ、見た目の歯ごたえを上げている
